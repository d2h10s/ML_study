...
while True:
    ...
    log_text = "running reward: {:9.2f} at episode {:7} --freq:{:7.3f} --time:{} --sigma:{:4.0}".format(running_reward, episode, most_freq, sigma, now_time)
    print(log_text)
    ...
    if 0.3 < most_freq < 0.5 and sigma > 30 or running_reward > MAX_REWARD:
