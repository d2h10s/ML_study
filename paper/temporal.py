...
def model_init():
    if len(sys.argv) > 1:
        global episode, running_reward, episode_reward
        arg_dir = sys.argv[1]
...
def proceed_one_episode():
    ...
    return action_probs_buffer, critic_value_buffer, rewards_history
...
while True:
    ...
    with tf.GradientTape() as tape:
        action_probs, critic_value, rewards_history = proceed_one_episode()
